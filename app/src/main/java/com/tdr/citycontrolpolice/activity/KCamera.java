...
import com.tdr.citycontrolpolice.util.TempConstants;
import com.tdr.citycontrolpolice.view.dialog.ZProgressHUD;
...
public class KCamera extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    byte[] data = idcardA;
                    saveCardImg2SD(data);
                    String headPath = OCRUtil.getFilePath(TempConstants.ROOT_DIR, new Date().toString(), "bmp", KCamera.this);//头像路径
    ...
    private void saveCardImg2SD(byte[] data) {
        ...
        try {
            String cardImgPath =  OCRUtil.getFilePath(TempConstants.ROOT_DIR, new Date().toString(), "jpg", KCamera.this);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case OcrEngine.RECOG_OK:
                    ...
                    intent.putExtra("img", cardImgBase64);//压缩身份证并转成Base64格式
