 ...
 * 修改备注：
 */
public class KjRoomModifyActivity extends BackTitleActivity implements BottomListPop.OnBottemPopSelectListener, View.OnClickListener, DialogConfirm.OnConfirmClickListener, WebServiceCallBack<ChuZuWu_RoomInfo> {
    private HashMap<String, Object> mParam = new HashMap<>();
    private static final String TAG = "KjRoomModifyActivity";
    ...
    public void initNet() {
        ...
        ThreadPoolTask task = builder.setGeneralParam(mToken, 0, "ChuZuWu_RoomInfo", mParam)
                ...
                .setActivity(KjRoomModifyActivity.this)
    ...
    public void initData() {
        renovationPop = new BottomListPop(ll_root, KjRoomModifyActivity.this, renovationList);
        paymentPop = new BottomListPop(ll_root, KjRoomModifyActivity.this, paymentList);
