 ...
 * 修改备注：
 */
public class PersonInfoActivity2 extends BackTitleActivity implements BackTitleActivity.OnRightClickListener, CzfListDetailPop.OnPopClickListener {
    ...
    protected void initView() {
        ...
        czfListDetailPop = new CzfListDetailPop(rlParent, PersonInfoActivity2.this);
    }
    ...
    public void initNet() {
        ...
        ThreadPoolTask task = builder.setGeneralParam(mToken, 0, "ChuZuWu_ComprehensiveInfo", mParam)
                ...
                .setActivity(PersonInfoActivity2.this)
                .setCallBack(new WebServiceCallBack<ChuZuWu_ComprehensiveInfo>() {
                    ...
                    public void onSuccess(ChuZuWu_ComprehensiveInfo bean) {
                       ...
                       personnelinfolist = bean.getContent().getPERSONNELINFOLIST();
                        Log.i(TAG, "personnelinfolist: " + PersonInfoActivity2.this.personnelinfolist.size());
                        personInfoAdapter.setData(PersonInfoActivity2.this.personnelinfolist);
                        ll_empty.setVisibility(PersonInfoActivity2.this.personnelinfolist.size() == 0 ? View.VISIBLE : View.GONE);
                    }
