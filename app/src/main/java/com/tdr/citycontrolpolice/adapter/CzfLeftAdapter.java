 ...
 * 修改备注：
 */
public class CzfLeftAdapter extends BaseSimpleAdapter<ChuZuWu_LKSelfReportingOutList.ContentBean.PERSONNELINFOLISTBean> {

    public CzfLeftAdapter(Context context, List<ChuZuWu_LKSelfReportingOutList.ContentBean.PERSONNELINFOLISTBean> list) {
        super(context, list);
    }
    ...
    public View simpleGetView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View
                    .inflate(context, R.layout.item_apply_left, null);
        ...
        viewHolder.tvinfotime.setText(list.get(position).getOUTTIME().substring(0, 10));
