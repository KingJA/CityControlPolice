 ...
 * 修改备注：
 */
public class CzfPopulationAdapter extends BaseSimpleAdapter<ChuZuWu_LKJBInfoList.ContentEntity.PERSONNELINFOLISTEntity> {

    private OnClickDetailListener onClickDetailListener;

    public CzfPopulationAdapter(Context context, List<ChuZuWu_LKJBInfoList.ContentEntity.PERSONNELINFOLISTEntity> list) {
        super(context, list);
    }
